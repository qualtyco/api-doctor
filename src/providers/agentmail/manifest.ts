...
export const agentmailManifest: ProviderManifest = {
  ...
  surface: {
    ...
    // same-surface subclass). Cross-checked against the API reference index
    // (docs.agentmail.to/llms.txt): all 120 documented endpoints map to a
    // method below, including websockets.connect (the WebSocket Connect
    // page). Five entries are SDK-side extras present in the types but not
    // in the docs index — apiKeys.createPublicKey, apiKeys.listPublicKeys,
    // apiKeys.revokeAllAgentIdSignInKeys, apiKeys.revokePublicKey,
    // apiKeys.updatePublicKeyName (Fern-generated from the same API
    // definition; the endpoints exist but have no doc pages yet). The root
    // client's own fetch() passthrough is deliberately excluded — it is the
    // low-level escape hatch that unknown_sdk_calls exists to reveal.
    // Re-verify on agentmail SDK bumps (`pnpm check:surface`).
    methods: [
      'agent.signUp',
      'agent.verify',
      'apiKeys.create',
      'apiKeys.createPublicKey',
      'apiKeys.delete',
      'apiKeys.list',
      'apiKeys.listPublicKeys',
      'apiKeys.revokeAllAgentIdSignInKeys',
      'apiKeys.revokePublicKey',
      'apiKeys.updatePublicKeyName',
      'auth.me',
      'domains.create',
      'domains.delete',
      'domains.get',
      ...
      'domains.verify',
      'drafts.get',
      'drafts.getAttachment',
      'drafts.list',
      'inboxes.apiKeys.create',
      'inboxes.apiKeys.delete',
      'inboxes.apiKeys.list',
      'inboxes.create',
      'inboxes.delete',
      'inboxes.drafts.create',
      'inboxes.drafts.delete',
      'inboxes.drafts.get',
      'inboxes.drafts.getAttachment',
      'inboxes.drafts.list',
      'inboxes.drafts.send',
      ...
      'inboxes.lists.get',
      'inboxes.lists.list',
      'inboxes.messages.batchGet',
      'inboxes.messages.batchUpdate',
      'inboxes.messages.delete',
      'inboxes.messages.forward',
      'inboxes.messages.get',
      'inboxes.messages.getAttachment',
      'inboxes.messages.getRaw',
      'inboxes.messages.list',
      'inboxes.messages.reply',
      'inboxes.messages.replyAll',
      'inboxes.messages.search',
      'inboxes.messages.send',
      'inboxes.messages.update',
      'inboxes.metrics.queryEvents',
      'inboxes.metrics.queryUsage',
      'inboxes.threads.delete',
      'inboxes.threads.get',
      'inboxes.threads.getAttachment',
      'inboxes.threads.list',
      'inboxes.threads.search',
      'inboxes.threads.update',
      'inboxes.update',
      'inboxes.webhooks.create',
      'inboxes.webhooks.delete',
      'inboxes.webhooks.get',
      'inboxes.webhooks.getHeaders',
      'inboxes.webhooks.list',
      'inboxes.webhooks.update',
      'inboxes.webhooks.updateHeaders',
      'lists.create',
      'lists.delete',
      'lists.get',
      'lists.list',
      ...
      'pods.domains.delete',
      'pods.domains.get',
      'pods.domains.getZoneFile',
      'pods.domains.list',
      'pods.domains.update',
      'pods.domains.verify',
      'pods.drafts.get',
      'pods.drafts.getAttachment',
      'pods.drafts.list',
      'pods.get',
      'pods.inboxes.create',
      'pods.inboxes.delete',
      ...
      'pods.lists.get',
      'pods.lists.list',
      'pods.metrics.queryEvents',
      'pods.metrics.queryUsage',
      'pods.threads.delete',
      'pods.threads.get',
      'pods.threads.getAttachment',
      'pods.threads.list',
      'pods.threads.search',
      'pods.threads.update',
      'pods.webhooks.create',
      'pods.webhooks.delete',
      'pods.webhooks.get',
      'pods.webhooks.getHeaders',
      'pods.webhooks.list',
      'pods.webhooks.update',
      'pods.webhooks.updateHeaders',
      'threads.delete',
      'threads.get',
      'threads.getAttachment',
      'threads.list',
      'threads.search',
      'threads.update',
      'webhooks.create',
