...
| Missing App Check              | warning  | CWE-285, A04:2021  | Without App Check, unauthenticated clients can access Firestore and Realtime Database, bypassing authorization controls. | [Launch checklist](https://firebase.google.com/docs/database/web/start)                                                           | [missing-app-check.ts](rules/missing-app-check.ts)                           | [test](../../../tests/rules/firebase-missing-app-check.test.ts)              |
...
| Use Timestamp.now()               | info     | Uses new Date() instead of Timestamp.now(), creating inconsistency that breaks Firestore security rule comparisons. | [Timestamp reference](https://firebase.google.com/docs/reference/js/firestore_.timestamp)                          | [use-timestamp-now.ts](rules/use-timestamp-now.ts)                                 | [test](../../../tests/rules/firebase-use-timestamp-now.test.ts)                 |
