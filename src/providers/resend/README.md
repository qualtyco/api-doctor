...
| ------------------------- | -------- | ------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| Webhook signature missing | error    | CWE-345, API2:2023 | [Verify signatures](https://resend.com/docs/webhooks/verify-webhooks-requests) | [webhook-signature.ts](rules/webhook-signature.ts)               | [resend-webhook-signature.test.ts](../../../tests/resend-webhook-signature.test.ts)                     |
