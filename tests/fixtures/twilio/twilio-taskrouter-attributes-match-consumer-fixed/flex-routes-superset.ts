...
// Looks suspicious because the producer's attribute object has a different
// shape than what's destructured, but it's a strict superset — every field
// the consumer reads is actually present, plus extras for logging.
