...
const ruleKey = 'agentmail-inbox-create-client-id';

describe('agentmail-inbox-create-client-id rule', () => {
  it('flags both broken fixtures (state-file get-or-create, no-args create)', () => {
